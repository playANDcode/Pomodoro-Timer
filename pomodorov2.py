...
"""
Todo:
- Add an exception error in soundfile_directories() if file isn't discovered
...
def timer_with_menu(t: int):
    ...
    while t:  # while t > 0 for clarity
        try:
            ...
            t -= 1
            # Bug:
            # Description: While these timer specifically try block is running
            # ; inputs gets recorded
            # ;The recorded inputs then transfers to the "except block"
            # Replicate: While timer is running
